...
export const setPitch = async(pitch: number) => TrackPlayer.setPitch(pitch)
export const setEqualizerEnabled = async(enabled: boolean) => TrackPlayer.setEqualizerEnabled(enabled)
export const setEqualizerBandLevel = async(band: number, level: number) => TrackPlayer.setEqualizerBandLevel(band, level)
